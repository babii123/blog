...
import { GetAritcleListModel, AuthorCardModel, TypeModel, ArticleInfoModel, DetailRelateModel, FramerInfoModel, ArticleCountModel, ArticleEditModel, FramerEditModel, ArticleDetailModel } from "../model/ResponseModel";
